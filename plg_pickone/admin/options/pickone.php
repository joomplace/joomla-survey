...
<tr>
	<td><?php echo JText::_('COM_SURVEYFORCE_SECTION'); ?>:</td><td><?php echo $lists['sf_section_id'];?></td>
</tr>
<?php }?>		
<tr>
	<td width="100">
		<?php echo JText::_('COM_SURVEYFORCE_USE_DROP_DOWN_STYLE'); ?>:
	</td>
	<td>
...
<div style="text-align:left; padding-left:30px ">
	...
	<br/><br/>
	<input class="btn" type="button" name="set_default" value="<?php echo JText::_('COM_SURVEYFORCE_SET_DEFAULT'); ?>" onClick="<?php echo ($row->id > 0?"javascript: location.href = '".$setDefaultLink."';":"javascript: alert('".JText::_('COM_SURVEYFORCE_YOU_CAN_SET_DEFAULT_ANSWERS')."');")?>">
