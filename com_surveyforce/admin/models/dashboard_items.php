...
class SurveyforceModelDashboard_items extends JModelList {
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__survey_force_dashboard_items`');
    ...
    function delete($cid) {
        $db = JFactory::getDbo();
        $query = $db->getQuery(true);
        $query->delete('#__survey_force_dashboard_items');
    ...
    public function publish($cid, $value = 1) {
        ...
        $query = "UPDATE #__survey_force_dashboard_items"
