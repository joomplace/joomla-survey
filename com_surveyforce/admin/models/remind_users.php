...
class SurveyforceModelRemind_users extends JModelAdmin {
    ...
    public function getForm($data = array(), $loadData = true) {
        ...
        $form = $this->loadForm('com_surveyforce.remind_users', 'remind_users', array('control' => 'jform', 'load_data' => false));
        if (empty($form)) {
            return false;
        }
