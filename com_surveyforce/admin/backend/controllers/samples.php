...
class SurveyforceControllerSamples extends JControllerForm {
    ...
    public function installsample1() {
		...
		$profile->sf_author = json_encode($profile->sf_author);
