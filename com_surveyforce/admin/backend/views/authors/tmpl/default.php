...
<form action="<?php echo JRoute::_('index.php?option=com_surveyforce&view=authors'); ?>" method="post" id="adminForm" name="adminForm" >
    ...
    <div id="j-main-container" class="span10">
	    ...
	    <table class="table table-striped" id="surveyforceList">
		    ...
		    <tr>
			    ...
			    <th class="center">
				    <?php echo JHtml::_('grid.sort', 'COM_SURVEYFORCE_USERNAME', 'username', $listDirn, $listOrder); ?>
			    </th>
			    <th class="nowrap center">
				    <?php echo JHtml::_('grid.sort', 'COM_SURVEYFORCE_EMAIL', 'email', $listDirn, $listOrder); ?>
			    </th>
			    <th class="nowrap center">
				    <?php echo JHtml::_('grid.sort', 'COM_SURVEYFORCE_LAST_VISIT', 'lastvisitDate', $listDirn, $listOrder); ?>
			    </th>
		    </tr>
		    </thead>
		    <tfoot>
