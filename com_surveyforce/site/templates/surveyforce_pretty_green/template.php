...
if (!class_exists('surveyforce_template_class')) {
    ...
    class surveyforce_template_class {
        ...
        public static function SF_MainLayout() {
            ...
            $document->addScript('/components/com_surveyforce/templates/surveyforce_pretty_green/choosen.js');  
            $document->addStyleSheet('/components/com_surveyforce/templates/surveyforce_pretty_green/choosen.css');
			...
			<link rel="stylesheet" type="text/css" href="{$mosConfig_live_site}components/com_surveyforce/templates/surveyforce_pretty_green/surveyforce.css"/>
			<!--[if lte IE 8]> <link rel="stylesheet" href="{$mosConfig_live_site}components/com_surveyforce/templates/surveyforce_pretty_green/ie.css" type="text/css"/><![endif]-->
...
EOFTMPL;
        ...
        public static function SF_GetElements($sf_config) {
            ...
            <script language="javascript" type="text/javascript"><!--//--><![CDATA[//><!--
                    preload([
                    '<?php echo JURI::root() ?>components/com_surveyforce/templates/surveyforce_pretty_green/images/check_off_green.png',
                    '<?php echo JURI::root() ?>components/com_surveyforce/templates/surveyforce_pretty_green/images/check_on.png',
                    '<?php echo JURI::root() ?>components/com_surveyforce/templates/surveyforce_pretty_green/images/custom_select.png',
                    '<?php echo JURI::root() ?>components/com_surveyforce/templates/surveyforce_pretty_green/images/radio_off_green.png',
                    '<?php echo JURI::root() ?>components/com_surveyforce/templates/surveyforce_pretty_green/images/radio_on.png'
                ]);
                var new_template = 1;
                function getLikertScale(n) {
                    ...
                    var return_str = '<div align="left" class="likert_scale_div">' +
                            ...
                            '<br/>' +
                            '<table id="quest_table" class="likert_scale_table" cellpadding="0" cellspacing="0">';
                    ...
                    if (acount > 0) {
                        ...
                        if (quest_style == 1) {
                            ...
                            return_str = return_str + '<tr>' +
                                    ...
                                    '<label style="display: inline;left: -18px;position:relative;" for="quest_radio' + questions[n].cur_quest_id + 'e">' + SF_getElement(data, 'afield_text', 0) + '</label>' +
                                    '<input class="po_other" type="text" id="other_op_' + questions[n].cur_quest_id + '" name="other_op_' + questions[n].cur_quest_id + '" value="' + other_val + '"/>' +
                                    '</td>' +
                                    '</tr>';
                        }
                ...
                function getPickMany(n) {
                    ...
                    if (acount > 0) {
                        ...
                        return_str = return_str + '<tr>' +
                                ...
                                '<label style="display: inline;left: -18px;position: relative;" onclick="javascript: return check_num_opt(' + n + ', this)" for="quest_check' + questions[n].cur_quest_id + 'e">' +
                    ...
                    if (iscount > 0) {
                        ...
                        for (j = 0; j < iscount; j++) {
                            ...
                            return_str = return_str + '<td class="i_ans_cell" onclick="javascript: sf_getObj(\'iscale_radio' + questions[n].cur_quest_id + '_' + j + '\').checked=\'checked\';">' +
                                    '<input class="i_radio" type="radio" name="iscale_radio' + questions[n].cur_quest_id + '" id="iscale_radio' + questions[n].cur_quest_id + '_' + j + '" value="' + SF_getElement(data, 'isfield_id', j) + '" ' + selected + '/>' + '<label for="iscale_radio' + questions[n].cur_quest_id + '_' + j + '" class="iscale_label">' + SF_getElement(data, 'isfield_text', j) + '</label>' +
                                    '</td>';
                        }
                        return_str = return_str + "<\/tr>";
                        return_str = return_str + "<\/table><\/form><\/div>";
