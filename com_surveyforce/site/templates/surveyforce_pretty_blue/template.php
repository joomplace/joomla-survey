...
if (!class_exists('surveyforce_template_class')) {
    ...
    class surveyforce_template_class {
        ...
        public static function SF_MainLayout() {
            ...
            $document->addScript(JUri::root() . 'components/com_surveyforce/templates/surveyforce_pretty_blue/choosen.js');
            $document->addStyleSheet(JUri::root() . 'components/com_surveyforce/templates/surveyforce_pretty_blue/choosen.css');
			...
			<link rel="stylesheet" type="text/css" href="{$mosConfig_live_site}components/com_surveyforce/templates/surveyforce_pretty_blue/surveyforce.css"/>
			<!--[if lte IE 8]> <link rel="stylesheet" href="{$mosConfig_live_site}components/com_surveyforce/templates/surveyforce_pretty_blue/ie.css" type="text/css"/><![endif]-->

			<div id="surveyforce" calss="contentpane surveyforce">
			<div class="componentheading"><h2 class="jb_survey_container_title">{SURVEY_NAME}</h2></div>
...
EOFTMPL;
        ...
        public static function SF_GetElements($sf_config) {
            ...
            <script language="javascript" type="text/javascript"><!--//--><![CDATA[//><!--
                    preload([
                    '<?php echo JURI::base() ?>components/com_surveyforce/templates/surveyforce_pretty_blue/images/check_off.png',
                    '<?php echo JURI::base() ?>components/com_surveyforce/templates/surveyforce_pretty_blue/images/check_on.png',
                    '<?php echo JURI::base() ?>components/com_surveyforce/templates/surveyforce_pretty_blue/images/custom_select.png',
                    '<?php echo JURI::base() ?>components/com_surveyforce/templates/surveyforce_pretty_blue/images/radio_off.png',
                    '<?php echo JURI::base() ?>components/com_surveyforce/templates/surveyforce_pretty_blue/images/radio_on.png'
                ]);
