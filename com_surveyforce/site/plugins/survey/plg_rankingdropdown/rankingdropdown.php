...
class plgSurveyRankingdropdown {
    ...
    public function onGetAdminOptions($data, $lists) {
        ...
        ob_start();
        include_once(JPATH_SITE . "/plugins/survey/rankingdropdown/admin/js/rankingdropdown.js.php");
        include_once(JPATH_SITE . "/plugins/survey/rankingdropdown/admin/options/rankingdropdown.php");
